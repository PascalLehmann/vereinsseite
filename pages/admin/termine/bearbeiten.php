...
// Default Spielführer ermitteln (Sportwart oder Vorsitzender)
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                <?php for ($i = 1; $i <= 6; $i++): ?>
                    <div class="form-group">
                        ...
                        <select id="s<?= $i ?>" name="s<?= $i ?>" class="form-control select2-box player-select" style="width: 100%;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                <?php for ($i = 1; $i <= 3; $i++): ?>
                    <div class="form-group">
                        ...
                        <select id="a<?= $i ?>" name="a<?= $i ?>" class="form-control select2-box player-select" style="width: 100%;">
                            <option value="">- Leer -</option>
                            <?php foreach ($spieler_liste as $s): ?>
                ...
                <div class="form-group">
                    ...
                    <select id="spielfuehrer_id" name="spielfuehrer_id" class="form-control select2-box"
                        ...
                        <?php foreach ($spieler_liste as $s): ?>
                            <option value="<?= $s['id'] ?>" <?= ($t['spielfuehrer_id'] ?: $default_spielfuehrer_id) == $s['id'] ? 'selected' : '' ?>>
                                <?= htmlspecialchars($s['vorname'] . ' ' . $s['nachname']) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
