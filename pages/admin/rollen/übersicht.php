        ...
        try {
            ...
            if (count($db_rollen) > 0) {
                ...
                foreach ($db_rollen as $rolle) {
                    ...
                    echo "<a href='löschen.php?id=" . $rolle['id'] . "' class='delete-link' title='Löschen' onclick='return confirm(\"Möchtest du die Rolle '" . htmlspecialchars($rolle['name']) . "' wirklich löschen?\");'><i class='fas fa-trash'></i></a>";
                    echo "</td>";
                    echo "</tr>";
                }
                echo "</table>";
