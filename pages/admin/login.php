...
<main>
    <div style="display: flex; justify-content: center; align-items: center; height: 100%; min-height: 50vh;">
        <div class="content-tile" style="max-width: 400px; width: 100%; margin: 0 auto;">
            <div style="text-align: center; margin-bottom: 25px;">
                <i class="fas fa-user-shield"
                    style="font-size: 3rem; color: var(--sidebar-color); margin-bottom: 15px;"></i>
