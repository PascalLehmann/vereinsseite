    ...
    <div class="container">
        ...
        <main class="content">
            ...
            <div class="news-card" style="margin-top: 20px;">
                ...
                <h1 style="color: var(--secondary-blue); margin: 10px 0;">Details zum Termin #<?php echo $terminId; ?></h1>
                ...
                <div style="margin-top: 25px; display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div style="padding: 15px; background: rgba(255,140,0,0.05); border-radius: 8px;">
                        <i class="fa-solid fa-calendar-days" style="color: var(--primary-orange); margin-right: 10px;"></i>
                    ...
                    <div style="padding: 15px; background: rgba(255,140,0,0.05); border-radius: 8px;">
                        <i class="fa-solid fa-location-dot" style="color: var(--primary-orange); margin-right: 10px;"></i>
                ...
                <div style="margin-top: 30px; line-height: 1.7; padding: 20px; background: #f9f9f9; border-radius: 8px;">
                    <h3 style="margin-bottom: 15px;">Zusätzliche Informationen</h3>
                    <p>Hier werden später alle zusätzlichen Informationen stehen, die wir in der Datenbank für diesen speziellen Termin hinterlegen.</p>
                    <p>Das Training richtet sich an alle Altersklassen von 10 bis 16 Jahren. Bitte pünktlich erscheinen und Sportkleidung sowie Hallenschuhe mitbringen. Neue Interessenten sind herzlich zu einem Probetraining eingeladen!</p>
                </div>
            </div>
        </main>
    </div>
