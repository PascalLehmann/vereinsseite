...
<main>
    <div class="action-bar">
        ...
        <a href="erstellen.php" class="btn btn-primary">Neuen Benutzer anlegen</a>
    </div>
        ...
        try {
            ...
            if (count($users) > 0) {
                ...
                foreach ($users as $u) {
                    ...
                    echo "<td>";
                    echo "<a href='bearbeiten.php?id=" . $u['id'] . "' class='action-link'>Rollen / PW bearbeiten</a>";
                    echo "<a href='loeschen.php?id=" . $u['id'] . "' class='delete-link' onclick='return confirm(\"User löschen?\");'>Löschen</a>";
                    echo "</td>";
                    echo "</tr>";
                }
                echo "</table>";
