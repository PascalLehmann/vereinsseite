        ...
        <main class="content">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 20px; margin-top: 30px;">
                ...
                <article class="news-card" style="text-align: center;">
                    ...
                    <p style="font-size: 0.9rem; color: #666; margin: 10px 0;">Leitung des Vereins und Repräsentation nach außen.</p>
                ...
                <article class="news-card" style="text-align: center;">
                    ...
                    <p style="font-size: 0.9rem; color: #666; margin: 10px 0;">Stellvertretende Leitung und Projektkoordination.</p>
                ...
                <article class="news-card" style="text-align: center;">
                    ...
                    <p style="font-size: 0.9rem; color: #666; margin: 10px 0;">Verantwortlich für Finanzen und Mitgliederverwaltung.</p>
