    ...
    <div class="container">
        ...
        <main class="content">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 25px; margin-top: 30px;">
                ...
                <a href="news/übersicht.php" style="text-decoration: none; color: inherit;">
                ...
                <a href="termine/übersicht.php" style="text-decoration: none; color: inherit;">
                ...
                <a href="mitglieder/übersicht.php" style="text-decoration: none; color: inherit;">
                ...
                <a href="gegner/übersicht.php" style="text-decoration: none; color: inherit;">
